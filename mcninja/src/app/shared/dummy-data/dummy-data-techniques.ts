export default [
    ...
    },
    {
      ...
      belt: 'Tan',
      description: "The rear hand punch is a snapping punch executed by the rear hand. It is a power punch designed to inflict maximum damage on your aggressor. Its power comes from pushing off your rear leg and rotating your hips and shoulders.",
      execution: ["Assume the basic warrior stance.",
    ...
    },
    {
      ...
      title: 'Uppercut',
      belt: 'Tan',
      description: "The uppercut is a powerful punch originating below the aggressor's line of vision. It is executed in an upward motion traveling up the centerline of the aggressor's body. It is delivered in close and usually follows a preparatory strike that leaves the target area unprotected. When delivered to the chin or jaw, the uppercut can render an aggressor unconscious, cause extensive damage to the neck, and/or sever the tongue.",
      execution: [ " Assume the basic warrior stance.",
    ...
    },
    {
      ...
      title: 'Hook',
      belt: 'Tan',
      description: "The hook is a powerful punch that is executed close-in and is usually preceded by a preparatory strike.",
      execution: [" Assume the basic warrior stance.",
    ...
    },
    {
      ...
      title: 'Eye Gouge',
      belt: 'Tan',
      description: "The eye gouge is used to attack the aggressor’s eyes, blinding him so follow on techniques can be executed.",
      execution: ["From the basic warrior stance, open your left hand with your fingers spread apart and slightly bent.",
    ...
    },
    {
      ...
      belt: 'Tan',
      description: "Striking with the hammer fist concentrates power in a small part of the hand which can have a devastating effect when transferred to the target.",
      execution: ["From the basic warrior stance, retract your right hand so your fist is next to your face. Simultaneously rotate your right hip and shoulder backwards.",
    ...
    },
    {
      ...
      belt: 'Tan',
      description: "Striking with the hammer fist concentrates power in a small part of the hand which, when transferred to the target, can have a devastating effect.",
      execution: ["From the basic warrior stance, retract your right hand so your fist is next to your face. Simultaneously rotate your right hip and shoulder backwards.",
      ...
      },
    {
      ...
      belt: 'Tan',
      description: "Elbow strikes are close range weapons that inflict a great amount of damage due to leverage and the transfer of your body weight.",
      execution: ["From the basic warrior stance, bend your right elbow keeping your fist close to your body. Your fist is at shoulder level and your elbow is next to your torso.",
    ...
    },
    {
      ...
      belt: 'Tan',
      description: "Elbow strikes are close range weapons that inflict a great amount of damage due to leverage and the transfer of your body weight.",
      execution: [ "From the basic warrior stance, bring your elbow up and tuck your right fist near your chest with the palm facing the deck.",
    ...
    },
    {
      ...
      title: 'Rear Choke',
      belt: 'Tan',
      description: "The rear choke is performed when you are behind the aggressor, when he is on the ground, or when you are taking him to the ground.",
      execution: ["Begin with the aggressor kneeling on the deck while you stand behind him.",
    ...
    },
    {
      ...
      belt: 'Tan',
      description: "The figure-four is a variation that allows you to gain more leverage on the rear choke. If you cannot secure the rear choke, you may apply the figure-four variation to increase the pressure of the choke on the aggressor.",
      execution: ["Apply a rear choke. Your body should be against the aggressor's body.",
    ...
    },
    {
      ...
      title: "Leg Sweep",
      belt: 'Tan',
      description:"A leg sweep is particularly effective if the aggressor is moving backward or pulling on you.",
      execution: [    "tart facing the aggressor in the basic warrior stance.",
    ...
    },
    {
      ...
      title: 'Front Kick',
      belt: 'Tan',
      description: "The front kick is used to stop the aggressor’s forward momentum or to set him up for follow on techniques when the aggressor is in front of you.",
      execution: [ "From the basic warrior stance, raise your right knee waist high and pivot your hips into the attack, thrusting your right foot forward toward the aggressor. You may have to shift your body weight to your left leg to maintain balance.",
    ...
    },
    {
      ...
      title: 'Round Kick',
      belt: 'Tan',
      description: "The round kick is used to cause maximum damage to the knee or to set up the aggressor for follow on techniques.",
      execution: [ "From the basic warrior stance, point the foot of your left leg 45 degrees to the outside of the aggressor and raise your right leg slightly off the deck. You may have to shift your body weight to your left leg to maintain balance.",
    ...
    },
    {
      ...
      belt: 'Tan',
      description: "The vertical stomp is used to attack the aggressor when he is on the deck and you are standing.",
      execution: [  "From the basic warrior stance, raise the knee of your right foot above waist level. Your right leg should be bent at a 90 degree angle. Shift your body weight to your left leg to maintain your balance.",
    ...
    },
    {
      ...
      belt: 'Tan',
      description: "The vertical knee strike is used to inflict major damage during close range fighting or grappling.",
      execution: ["From the basic warrior stance, grab the aggressor’s neck or gear with both hands without interlacing your fingers. If you interlace your fingers, your aggressor can pull back or reach behind their head and break the fingers.",
